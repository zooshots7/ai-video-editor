...
export const metadata = createMetadata({
  title: {
    ...
    default: "ReelForge - AI Video Editor",
  },
  description: "AI-powered video editor for Instagram creators. Auto-edit your videos with B-roll, captions, transitions, and SFX.",
